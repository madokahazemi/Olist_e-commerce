...
1) Regions: The performance of each region is evaluated based on the total sales and number of customers.
2) Customers: The total number of customers and the rate of customer growth are evaluated.
3) Product Categories: The total sales for each product category are evaluated.
